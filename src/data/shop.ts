...
export const SHOP_CATALOG: ShopCatalogItem[] = [
  ...
  { id: 'flipping-jig', name: 'Flipping Jig', kicker: 'Jig — Works almost everywhere', type: 'Jig', difficultyLabel: 'Intermediate', difficultyScore: 5, targetFish: 'Largemouth & smallmouth bass', description: "This is the jig you tie on when you don't know what else to throw.", price: 5.5 },
  { id: 'medium-crankbait', name: 'Medium Crankbait', kicker: 'Crankbait — Steady retrieve, internal rattle', type: 'Crankbait', difficultyLabel: 'Beginner', difficultyScore: 2, targetFish: 'Largemouth & smallmouth bass', description: 'Cast it out and reel it back steady — the rattle and wobble do the attracting for you.', price: 8.5 },
  { id: 'wacky-worm', name: 'Wacky Worm', kicker: 'Soft plastic — Wacky-rigged worm', type: 'Soft Plastic', difficultyLabel: 'Beginner', difficultyScore: 2, targetFish: 'Bass & panfish', description: 'Rig it, cast it, let it sink and shimmy. Hard to fish wrong.', price: 6.25 },
  { id: 'chatterbait', name: 'Chatterbait', kicker: 'Bladed jig — Vibrates for stained water', type: 'Bladed Jig', difficultyLabel: 'Intermediate', difficultyScore: 4, targetFish: 'Largemouth bass', description: 'Vibrates as you reel, so fish can find it even in stained or cloudy water.', price: 7.75 },
  { id: 'urchin-finesse-bait', name: 'Urchin Finesse Bait', kicker: 'Soft plastic — Finesse, for tough bites', type: 'Soft Plastic', difficultyLabel: 'Advanced', difficultyScore: 6, targetFish: 'Largemouth & smallmouth bass', description: 'Small, subtle, and easy to drop right next to cover on the days nothing else gets bit.', price: 4.95 },
  { id: 'bulk-sinkers', name: 'Bulk Sinkers', kicker: 'Weights — Assorted, 10-pack', type: 'Weights', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'Any species', description: 'Basic, boring, and exactly what you need to get a bait down to the fish.', price: 4.5 },
  { id: 'bobbers', name: 'Bobbers', kicker: 'Float — Snap-on, assorted sizes', type: 'Float', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'Panfish & bass', description: 'The bobber going under is the easiest bite you’ll ever learn to read.', price: 4.75 },
  { id: 'split-shot-weights', name: 'Split Shot Weights', kicker: 'Weights — Reusable, pack of 20', type: 'Weights', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'Any species', description: 'Pinch one on to sink a bait just enough to hang below a bobber.', price: 3.95 },
  { id: 'scented-soft-bait', name: 'Scented Soft Bait', kicker: 'Bait — No live bait needed', type: 'Soft Plastic', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'Panfish, trout & bass', description: 'Works like a real worm without a trip to dig for one.', price: 5.25 },
  { id: 'bobber-stops', name: 'Bobber Stops & Beads', kicker: 'Rigging — Adjustable, pack of 20', type: 'Rigging', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'Any species', description: 'Set exactly how deep your bait hangs below a bobber.', price: 3.5 },
  { id: 'junior-spinning-combo', name: 'Junior Spinning Combo', kicker: "Combo — 5-6' light-action rod + reel", type: 'Combo', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'First-ever trips, kids', description: 'A shorter, lighter combo — easier to actually hold and reel on a first trip.', price: 39.99 },
  { id: 'circle-hooks', name: 'Circle Hooks', kicker: 'Hooks — 5/0-7/0, for catfish', type: 'Hooks', difficultyLabel: 'Beginner', difficultyScore: 2, targetFish: 'Catfish', description: 'Hooks catfish in the corner of the mouth almost on their own.', price: 5.95 },
  { id: 'dip-bait-treble-hooks', name: 'Dip Bait Treble Hooks', kicker: 'Hooks — Bait-holder spring treble', type: 'Hooks', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'Catfish', description: 'Built to hold prepared stink/dip bait through the cast.', price: 5.5 },
  { id: 'sliding-egg-sinkers', name: 'Sliding Egg Sinkers', kicker: 'Weights — 1 oz, slip-sinker rig', type: 'Weights', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'Catfish', description: 'Lets a catfish pick up bait and swim off without feeling the weight.', price: 4.5 },
  { id: 'no-roll-bank-sinkers', name: 'No-Roll Bank Sinkers', kicker: 'Weights — 2 oz, for current', type: 'Weights', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'Catfish', description: 'Flat sinkers that hold bottom in current instead of rolling away.', price: 4.75 },
  { id: 'barrel-swivels', name: 'Barrel Swivels', kicker: 'Rigging — Heavy-duty, 10-pack', type: 'Rigging', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'Catfish', description: 'Keeps your leader from twisting up on itself.', price: 4.25 },
  { id: 'fluorocarbon-leader', name: 'Fluorocarbon Leader Line', kicker: 'Line — 30 lb test', type: 'Rigging', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'Catfish', description: 'Abrasion-resistant enough to survive catfish dragging your rig across the bottom.', price: 8.5 },
  { id: 'catfish-stink-bait', name: 'Catfish Stink Bait', kicker: 'Bait — Prepared dip/paste', type: 'Prepared Bait', difficultyLabel: 'Beginner', difficultyScore: 1, targetFish: 'Catfish', description: 'No cut bait or chicken liver required to start — just dip and cast.', price: 6.5 },
  { id: 'catfish-spinning-combo', name: 'Catfish Spinning Combo', kicker: "Combo — 7' medium-heavy rod + reel", type: 'Combo', difficultyLabel: 'Beginner', difficultyScore: 2, targetFish: 'Catfish', description: 'Rated for the fight and the heavier weight of a full catfish rig.', price: 54.99 },
];
